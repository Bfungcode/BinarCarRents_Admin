...
export const getAllCars = createAsyncThunk("admin/getAllCars",
...
export const postCar = createAsyncThunk("admin/postCar",
    async ({ name, category, price, status, image }, thunkAPI) => {
        try {
...
export const getCarById = createAsyncThunk("admin/getCarById",
    async ({ id }, thunkAPI) => {
        try {
...
export const updateCarById = createAsyncThunk("admin/updateCarById",
    async ({ id }, thunkAPI) => {
        try {
            const response = await adminAPI.updateCarById(id);
            thunkAPI.dispatch(setMessage('done'))
            return response.data
        }
        catch (err) {
...
export const deleteCarById = createAsyncThunk("admin/deleteCarById",
    async ({ id }, thunkAPI) => {
        try {
...
export const getOrderById = createAsyncThunk("admin/getOrderById",
    async ({ id }, thunkAPI) => {
        try {
...
export const changeOrderStatus = createAsyncThunk("admin/changeOrderStatus",
    async ({ id }, thunkAPI) => {
        try {
            const response = await adminAPI.changeOrderStatus(id);
            thunkAPI.dispatch(setMessage('done'))
            return response.data
        }
        catch (err) {
...
export const getListOrder = createAsyncThunk("admin/updateCarById",
    async ({ sort, page, pageSize }, thunkAPI) => {
        try {
